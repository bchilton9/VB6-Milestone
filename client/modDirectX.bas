...
Dim key As DDCOLORKEY
    ...
    If FileExist("\GFX\sprites.bmp") = False Or FileExist("\GFX\tiles0.bmp") = False Or FileExist("\GFX\items.bmp") = False Or FileExist("\GFX\bigsprites.bmp") = False Or FileExist("\GFX\emoticons.bmp") = False Then
    ...
    Set DD_TileSurf = DD.CreateSurfaceFromFile(App.Path & "\GFX\tiles0.bmp", DDSD_Tile)
